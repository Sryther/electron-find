...
function onInput () {
  setTimeout(() => {
    ...
    if (text && text !== this[lastText]) {
      ...
      this.startFind(text, true, this[matchCase], false);
...
function onCaseClick () {
  ...
  wrapInput(this[findInput], this[findCase], 100);
  this.startFind(this[findInput].value, true, this[matchCase], false);
}
